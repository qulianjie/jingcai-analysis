...
for num in missing_nums:
    ...
    # Create dir: match21_斯塔贝克__桑纳菲尤尔
    dir_num = int(num)
    ...
    print(f'  league={meta["league"]} fid={meta["fid"]} home_id={meta["home_id"]} away_id={meta["away_id"]} macau={meta["macau_line"]}')
    ...
    print(f'  -> final_report_generator...')
    try:
        r = subprocess.run(
