...
# step235_runner.py writes 2,3,5 data to each file - read from one source
s235 = rd(os.path.join(G1, 'step02_jingcai_same.md'))
if not s235:
    s235 = rd(os.path.join(G2, 'step05_handicap_same.md'))
s2 = s235  # same combined output
s3 = s235  # same combined output
